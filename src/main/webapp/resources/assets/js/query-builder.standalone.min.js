...
!function (a, b) {
    ...
    $.extendext = function () {
        ...
        for ("boolean" == typeof g && (j = g, g = arguments[h++] || {}), "string" == typeof g && (k = $([g.toLowerCase(), "default"]).filter(["default", "concat", "replace", "extend"])[0], g = arguments[h++] || {}), "object" == typeof g || $.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++)if (null !== (a = arguments[h]))if ($.isArray(a) && "default" !== k)switch (f = g && $.isArray(g) ? g : [], k) {
            case"concat":
        ...
        } else for (b in a)c = g[b], d = a[b], g !== d && (j && d && ($.isPlainObject(d) || (e = $.isArray(d))) ? (e ? (e = !1, f = c && $.isArray(c) ? c : []) : f = c && $.isPlainObject(c) ? c : {}, g[b] = $.extendext(j, k, f, d)) : void 0 !== d && (g[b] = d));
        return g
    }
}), function () {
    "use strict";
    ...
    d.template = function (g, h, i) {
        ...
        var j, k, l = h.append ? e.append : e.split, m = 0, n = h.use || h.define ? a(h, g, i || {}) : g;
    ...
    g.templates = {}, g.regional = {}, g.OPERATORS = {
        ...
        default_group_flags: {condition_readonly: !1, no_delete: !1},
        templates: {group: null, rule: null, filterSelect: null, operatorSelect: null},
        lang_code: "en",
        lang: {},
        ...
        if (a && 0 !== a.length || l.error("Config", "Missing filters list"), a.forEach(function (a, c) {
            ...
            }, this), this.settings.sort_filters)if ("function" == typeof this.settings.sort_filters)a.sort(this.settings.sort_filters); else {
            var c = this;
            a.sort(function (a, b) {
        ...
        a = void 0 === a || a === !0;
        var d = this.nextGroupId(), e = $(this.getGroupTemplate(d, 1));
        ...
        b = void 0 === b || b === !0;
        var e = a.level + 1, f = this.trigger("beforeAddGroup", a, b, e);
        if (f.isDefaultPrevented())return null;
        var g = this.nextGroupId(), h = $(this.getGroupTemplate(g, e)), i = a.addGroup(h);
        ...
        var e = this.nextRuleId(), f = $(this.getRuleTemplate(e)), g = a.addRule(f);
        ...
        if (this.settings.display_errors)if (null === a.error)a.$el.removeClass("has-error"); else {
        ...
        if (a = $.extend({get_flags: !1}, a), !this.validate())return {};
        var b = this, c = function d(c) {
            var e = {condition: c.condition, rules: []};
        ...
        !function c(a, d) {
            null !== d && (void 0 === a.condition ? a.condition = b.settings.default_condition : -1 == b.settings.conditions.indexOf(a.condition) && l.error("UndefinedCondition", 'Invalid condition "{0}"', a.condition), d.condition = a.condition, a.rules.forEach(function (a) {
                var e;
                if (a.rules && a.rules.length > 0)if (-1 !== b.settings.allow_groups && b.settings.allow_groups < d.level)b.reset(), l.error("RulesParse", "No more than {0} groups are allowed", b.settings.allow_groups); else {
        ...
        var c, d = a.filter, e = a.operator, f = d.validation || {}, h = !0;
        ...
        if ("-1" == a)return null;
        for (var b = 0, c = this.filters.length; c > b; b++)if (this.filters[b].id == a)return this.filters[b];
        l.error("UndefinedFilter", 'Undefined filter "{0}"', a)
    }, g.prototype.getOperatorByType = function (a) {
        if ("-1" == a)return null;
        for (var b = 0, c = this.operators.length; c > b; b++)if (this.operators[b].type == a)return this.operators[b];
        l.error("UndefinedOperator", 'Undefined operator "{0}"', a)
    }, g.prototype.getRuleValue = function (a) {
        var b = a.filter, c = a.operator, d = [];
        if (b.valueGetter)d = b.valueGetter.call(this, a); else {
        ...
        if (c.valueSetter)c.valueSetter.call(this, a, b); else {
        ...
        var c = a.filter, d = a.filter.validation || {}, e = a.id + "_value_" + b, f = c.vertical ? " class=block" : "", h = "";
        if ("function" == typeof c.input)h = c.input.call(this, a, e); else switch (c.input) {
            case"radio":
            case"checkbox":
    ...
    var i = function (a, b) {
        return this instanceof i ? (Object.defineProperty(this, "__", {value: {}}), b.data("queryBuilderModel", this), this.__.level = 1, this.__.error = null, this.__.data = void 0, this.$el = b, this.id = b[0].id, this.model = null, void(this.parent = a)) : new i
    };
    ...
    l.iterateOptions = function (a, b) {
        ...
        this.on("getRuleInput.filter", function (b, c, d) {
            ...
            if (("radio" === e.input || "checkbox" === e.input) && !e.plugin) {
                ...
                var f = e.vertical ? ' style="display:block"' : "", g = 0;
                l.iterateOptions(e.values, function (c, h) {
                    var i = e.colors[c] || e.colors._def_ || a.color, j = d + "_" + g++;
                    b.value += "<div" + f + ' class="' + e.input + " " + e.input + "-" + i + '">   <input type="' + e.input + '" name="' + d + '" id="' + j + '" value="' + c + '">   <label for="' + j + '">' + h + "</label> </div>"
                })
            }
        })
    }, {font: "glyphicons", color: "default"}), g.define("bt-selectpicker", function (a) {
    ...
    }, {icon: "glyphicon glyphicon-info-sign", mode: "popover"}), g.defaults({
        operatorOpposites: {
            equal: "not_equal",
            not_equal: "equal",
            "in": "not_in",
        ...
        invert: function (a, b) {
            ...
            } else if (a instanceof k && a.operator && !a.filter.no_invert)if (this.settings.operatorOpposites[a.operator.type]) {
        ...
        mongoOperators: {
            equal: function (a) {
                ...
                return {$lt: a[0], $gt: a[1]}
            }, begins_with: function (a) {
                return {$regex: "^" + l.escapeRegExp(a[0])}
            }, not_begins_with: function (a) {
                return {$regex: "^(?!" + l.escapeRegExp(a[0]) + ")"}
            }, contains: function (a) {
                return {$regex: l.escapeRegExp(a[0])}
            }, not_contains: function (a) {
                return {$regex: "^((?!" + l.escapeRegExp(a[0]) + ").)*$", $options: "s"}
            ...
            $ne: function (a) {
                ...
                return a = a.$regex, "^(?!" == a.slice(0, 4) && ")" == a.slice(-1) ? {
                    ...
                    val: a.slice(4, -2),
                    op: "not_ends_with"
                } : "$" == a.slice(-1) ? {val: a.slice(0, -1), op: "ends_with"} : "^" == a.slice(0, 1) ? {
                    val: a.slice(1),
                    op: "begins_with"
                } : {val: a, op: "contains"}
            }, between: function (a) {
                ...
                return {val: [a.$lt, a.$gt], op: "not_between"}
            }, $in: function (a) {
        ...
        getMongo: function (a) {
            ...
            return function c(a) {
                ...
                a.rules.forEach(function (a) {
                    if (a.rules && a.rules.length > 0)d.push(c(a)); else {
                        var e = b.settings.mongoOperators[a.operator], f = b.getOperatorByType(a.operator), g = [];
            ...
            return function e(a) {
                ...
                g.forEach(function (a) {
                    var f = Object.keys(a);
                    if (c[f[0].toLowerCase()])h.push(e(a)); else {
                        var g = f[0], i = a[g], j = d(i, g);
                        ...
                        var m = k.call(b, i);
                        h.push({id: b.change("getMongoDBFieldID", g, i), field: g, operator: m.op, value: m.val})
                    }
                });
                var i = {};
    ...
    }, {default_no_sortable: !1, icon: "glyphicon glyphicon-sort"}), g.defaults({
        sqlOperators: {
            equal: {op: "= ?"},
            not_equal: {op: "!= ?"},
            "in": {op: "IN(?)", sep: ", "},
            ...
            "=": function (a) {
                ...
                return "%" == a.slice(0, 1) && "%" == a.slice(-1) ? {
                    val: a.slice(1, -1),
                    op: "contains"
                } : "%" == a.slice(0, 1) ? {val: a.slice(1), op: "ends_with"} : "%" == a.slice(-1) ? {
                    val: a.slice(0, -1),
                    op: "begins_with"
                ...
                return {val: a, op: "not_between"}
            }, IS: function (a) {
                return null !== a && l.error("SQLParse", "Invalid value for IS operator"), {val: null, op: "is_null"}
            }, "IS NOT": function (a) {
            ...
            question_mark: function (a) {
                ...
                (!b || b.length > 1) && (b = "$");
                var c = new RegExp("^\\" + b + "[0-9]+$"), d = new RegExp("\\" + b + "([0-9]+)", "g");
                return {
                    parse: function (b) {
                ...
                (!b || b.length > 1) && (b = ":");
                var c = new RegExp("^\\" + b), d = new RegExp("\\" + b + "(" + Object.keys(a).join("|") + ")", "g");
                return {
                    parse: function (b) {
        ...
        getSQL: function (a, b, c) {
            ...
            var e = this, g = function h(c) {
                ...
                return c.rules.forEach(function (c) {
                    if (c.rules && c.rules.length > 0)d.push("(" + b + h(c) + b + ")" + b); else {
                        var f = e.settings.sqlOperators[c.operator], g = e.getOperatorByType(c.operator), i = "";
            ...
            return a ? {sql: g, params: a.run()} : {sql: g}
            ...
            var c = this;
            if ("string" == typeof a && (a = {sql: a}), b === !0 && (b = "question_mark"), "string" == typeof b) {
                var d = f(b);
            ...
            var g = {condition: this.settings.default_condition, rules: []}, h = g;
            return function i(a, d) {
                if (-1 !== ["AND", "OR"].indexOf(a.operation.toUpperCase())) {
                    ...
                    h.rules.push({id: c.change("getSQLFieldID", m, f), field: m, operator: k.op, value: k.val})
                }
